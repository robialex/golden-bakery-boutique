      ...
      {showButton && (
        ...
        >
          <div className="container mx-auto px-4 pb-3">
            <a 
              href="https://ig.me/m/ingridbakes.cy" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="block w-full h-14 bg-[#A57F3A] text-white font-semibold text-base rounded-xl shadow-[0_4px_16px_rgba(165,127,58,0.3)] hover:shadow-[0_6px_24px_rgba(165,127,58,0.5)] transition-all duration-300 hover:scale-[1.02] flex items-center justify-center"
            >
              Order on Instagram
            </a>
          </div>
