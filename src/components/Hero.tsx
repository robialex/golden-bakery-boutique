...
const Hero = () => {
  ...
  return <>
      ...
      <section className="relative min-h-[55vh] md:min-h-[65vh] flex items-center justify-center overflow-hidden py-16 md:py-20">
        ...
        {/* Title & CTA */}
        <motion.div className="relative z-10 text-center w-full max-w-6xl mx-auto px-px py-0 my-0" style={{
        scale: titleScale,
        opacity: titleOpacity
          ...
          ease: [0.22, 1, 0.36, 1]
            ...
            delay: 0.2,
            ease: [0.22, 1, 0.36, 1]
          }} className="relative text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-display font-bold px-2 mb-6" style={{
      ...
      <section className="bg-card py-12 md:py-16 border-t-2 border-primary/30">
        <div className="container mx-auto px-4">
          ...
          ease: "easeOut"
            ...
            <motion.div className="relative rounded-xl md:rounded-2xl overflow-hidden border-2 border-primary/30 shadow-lift aspect-[4/3]" initial={{
            opacity: 0,
            x: 10
          }} whileInView={{
            opacity: 1,
            ...
            delay: 0.2
              ...
              <img alt="Ingrid Bakes boutique café interior in Nicosia" className="w-full h-full object-cover" loading="lazy" src="/lovable-uploads/7c82a3ed-3522-460d-9f60-2b7f303c590d.jpg" />
            </motion.div>
          </motion.div>
        </div>
      </section>
