...
export const VisitUs = () => {
  ...
  return (
    <section className="py-12 md:py-16 bg-card border-t-4 border-[#1B2C4B]">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          className="max-w-4xl mx-auto bg-background/10 p-6 md:p-8 rounded-xl shadow-lg"
        >
          <h2 className="text-3xl md:text-4xl font-display font-bold text-center mb-8 text-[#1B2C4B]">
            Visit Us
          </h2>
